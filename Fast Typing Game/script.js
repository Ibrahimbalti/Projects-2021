...
dropdown.value=localStorage.getItem('difficulty') !==null ?localStorage.getItem('difficulty') :'Easy';
...
//..........Start Function........
 async function fetchwords(){
    ...
    const words=res[Math.floor(Math.random()*res.length)]
    const typeword=words.word
   return typeword
...
const Timeinterval=setInterval(Decrement,1000);
...
function gameover(){
    ...
    <button style="font-size:18px" onClick="location.reload()">Play Again</button>
    `
}
